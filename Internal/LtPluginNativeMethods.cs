...
public static class LtPluginNativeMethods
{
    ...
    const string interface_lib = "Packages/com.lighttwist.lighttwistunitysdk/Internal/NativeLibrary/libLTUnityBridge.dylib";
    ...
    // tracking what we loaded for easier cleanup
        static readonly List<IntPtr> handles = new();
